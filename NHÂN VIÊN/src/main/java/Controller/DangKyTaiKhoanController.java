...
public class DangKyTaiKhoanController implements Initializable {
    ...
    @FXML
    private void handleDangKy() throws IOException, SQLException {
    ...
    private boolean kiemTraTonTai(String username, String sdt, String email) throws SQLException {
        String sql = "SELECT COUNT(*) FROM TAIKHOAN tk JOIN KHACHHANG kh ON tk.Ma_TK = kh.Ma_TK " +
    ...
    private void dangKyQuaFunction(String hoten, String sdt, String email,String username, String password) throws IOException {
