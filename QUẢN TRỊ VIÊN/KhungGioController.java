...
public class KhungGioController {
    ...
    public void initialize() {
        ...
        // Trỏ đúng vào hàm đổi chuỗi Str để hiển thị đẹp mắt (HH:mm)
    ...
    private void handleMoSuaKG() {
        ...
        try {
            ...
            if (TrangChuController.rootPane != null) TrangChuController.rootPane.setCenter(view);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    private void handleThoat() {
        chuyenTrang("QLySanVaKhungGio.fxml");
    }
